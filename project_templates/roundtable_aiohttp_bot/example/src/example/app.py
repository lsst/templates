...
from example.config import Configuration
from example.handlers import init_external_routes, init_internal_routes
...
def setup_metadata(*, app: web.Application, config: Configuration) -> None:
    ...
    meta: Dict[str, Any] = {
        ...
        "repository_url": "https://github.com/lsst-sqre/example",
